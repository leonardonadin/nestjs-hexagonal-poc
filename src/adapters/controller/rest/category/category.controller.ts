...
export class CategoryController {
  constructor(
    @Inject(ConfigServiceModule.FIND_ALL_CATEGORY_SERVICE)
    private readonly findAllCategoryService: FindAllCategoryService,
    @Inject(ConfigServiceModule.CREATE_CATEGORY_SERVICE)
  ...
  @Post()
  public createLivro(@Body() category: Category): Promise<Category> {
